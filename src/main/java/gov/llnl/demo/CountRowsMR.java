...
public class CountRowsMR extends Configured implements Tool {

  private static final Log LOG = LogFactory.getLog(CountRowsMR.class);
  ...
  /**
   * the hello world of mappers for HBase Map/Reduce programs
   * @author buttler1
   *
   */
  public static class CountRowMapper extends TableMapper<ImmutableBytesWritable, Put> {
